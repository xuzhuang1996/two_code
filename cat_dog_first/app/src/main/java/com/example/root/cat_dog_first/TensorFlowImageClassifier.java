...
public class TensorFlowImageClassifier implements Classifier {
    ...
    public List<Recognition> recognizeImage(final float[] pixels) {
        ...
        // Log.i("xu",Integer.toString(pixels.length) );
        Log.i(TAG,"read the pixels" );
        // Copy the input data into TensorFlow.
        Trace.beginSection("fillNodeFloat");
        inferenceInterface.fillNodeFloat(
                inputName, new int[]{1, inputSize, inputSize, 3}, pixels);
        Trace.endSection();
        Log.i(TAG,"fillNodeFloat" );
        // Run the inference call.
        Trace.beginSection("runInference");
        inferenceInterface.runInference(outputNames);
        Trace.endSection();
        Log.i(TAG,"readNodeFloat" );
        ...
        for (int i = 0; i < outputs.length; ++i) {
            Log.i("gailv",String.valueOf(outputs[i]));
        ...
        Log.i(TAG,String.valueOf(recognitions.size()) );
